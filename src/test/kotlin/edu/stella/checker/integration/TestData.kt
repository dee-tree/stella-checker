...
data class TestData(val name: String, val sourceCode: String, val expected: TestResult)

val TypeCheckErrorKind.isStep1: Boolean
    get() = this in errorsStep1

val TypeCheckErrorKind.isStep2: Boolean
    get() = this in errorsStep2


private val errorsStep1 = arrayOf(
    ERROR_MISSING_MAIN,
